    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-10">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="/" class="text-white/50 hover:text-white text-sm transition-colors duration-300">Home</a></li>
            ...
            <div>
                <h4 class="text-base font-semibold mb-4">Support</h4>
                <ul class="space-y-2">
                    ...
                    <li><a href="https://docs.k9crypt.xyz/default-guide/k9crypt-nodejs" class="text-white/50 hover:text-white text-sm transition-colors duration-300">Documents</a></li>
                </ul>
            </div>
        </div>

        <div class="border-t border-white/5 pt-8 text-center text-white/50 text-sm">
            <p>&copy; {new Date().getFullYear()} K9Crypt. All rights reserved.</p>
        </div>
    </div>
</footer>
