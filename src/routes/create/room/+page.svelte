    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-10 max-w-2xl">
        ...
        <div class="bg-cWhiteGray border border-white/5 rounded p-6 space-y-6">
            ...
            <div class="space-y-2">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <button class="px-4 py-2 rounded border-2 {selectedType === 'public' ? 'bg-cYellow/10 border-cYellow text-cYellow' : 'border-white/5 text-white/50'} font-medium transition-all duration-300" on:click={() => selectRoomType('public')}>
                        <i class="ri-global-fill mr-2"></i>
                        Public
                    </button>
                    <button class="px-4 py-2 rounded border-2 {selectedType === 'private' ? 'bg-cYellow/10 border-cYellow text-cYellow' : 'border-white/5 text-white/50'} font-medium" on:click={() => selectRoomType('private')}>
        ...
        <div class="mt-6 bg-cWhiteGray rounded border border-white/5 p-4">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                ...
                <button class="w-full bg-cYellow/10 border-2 border-cYellow text-cYellow py-2 px-4 rounded font-medium" on:click={handleJoinRoom}>Join Room</button>
            </div>
        </div>
        {/if}
