    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-10">
        ...
        <div class="space-y-12">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-cWhiteGray border border-white/5 rounded-lg p-6">
                    <img src={brandAssets.banner.path} alt="K9Crypt Banner" class="w-full object-cover rounded-md mb-4" />
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-cWhiteGray border border-white/5 rounded-lg p-6">
                        <div class="w-full h-24 rounded-md mb-4 border border-white/5" style="background-color: {color.hex}"></div>
                        <h3 class="font-semibold mb-2">{color.name}</h3>
                        <div class="space-y-1 text-sm text-white/50">
                            <p>HEX: {color.hex}</p>
                            <p>RGB: {color.rgb}</p>
                            <p class="mt-2">{color.usage}</p>
                        </div>
                    </div>
                    {/each}
                </div>
